...
const getWatchHistory = asyncHandler(async (req, res) => {
  const user = await User.aggregate([
    {
      $match: {
        // _id:req.user._id, dont do this , this wont work in agg pipeline
        _id: new mongoose.Types.ObjectId(req.user._id), //this is correct way
      },
    },
    {
      $lookup: {
        ...
        pipeline: [
          {
            $lookup: {
              ...
              pipeline: [
                {
                  //this will get project in owner since we have used sub pipeline
                  $project: {
                    fullName: 1,
                    username: 1,
                    avatar: 1,
